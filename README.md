...
- Contribution Reminders: Integrated notifications for upcoming payments.

-Transaction History: A transparent ledger for all contributions and payouts.
## Tech Stack
- Frontend: React.js (Hooks, Context API)

- Styling: Bootstrap CSS /Figma for UI design
